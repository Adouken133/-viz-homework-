...
# creating a 3D plot
malign = df[df['class'] == 'M']
benign = df[df['class'] == 'B']
fig = plt.figure()
axes = fig.add_subplot(1, 1, 1, projection='3d')
line1 = axes.scatter(malign['Alcohol'], malign['Malic_Acid'], malign['Ash'])
line2 = axes.scatter(benign['Alcohol'], benign['Malic_Acid'], benign['Ash'])
